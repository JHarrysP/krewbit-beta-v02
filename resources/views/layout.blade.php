...
<html lang="{{ app()->getLocale() }}">
 ...
 <!--        <link rel="stylesheet" href="{{asset('css/app.css')}}"> -->
        ...
        <link rel="stylesheet" href="{{asset('css/shatter.css')}}">
...
<script src="{{asset('js/charming.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/binary.js')}}" type="text/javascript"></script>
<script src="{{asset('js/pieces.js')}}" type="text/javascript"></script>
<script src="{{asset('js/main.js')}}" type="text/javascript"></script>
<script src="{{asset('js/keyboard.js')}}" type="text/javascript"></script>
<script src="{{asset('js/bootstrap.offcanvas.js')}}" type="text/javascript"></script>
